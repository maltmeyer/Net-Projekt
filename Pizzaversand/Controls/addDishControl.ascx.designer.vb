...
Partial Public Class WebUserControl1
    ...
    '''<summary>
    '''LabelIngrediants-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Zum Ändern Felddeklaration aus der Designerdatei in eine Code-Behind-Datei verschieben.
    '''</remarks>
    Protected WithEvents LabelIngrediants As Global.System.Web.UI.WebControls.Label
    
    '''<summary>
    '''gridViewIngredients-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Zum Ändern Felddeklaration aus der Designerdatei in eine Code-Behind-Datei verschieben.
